  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <!-- /.box-header -->
        <div class="box-body">            
          <form role="form" action="{{ route('customer-group.store') }}" method="POST">
            @csrf
            <div class="box-body">    
             <div class="row">
              <div class="col-lg-6 col-md-8 col-sm-12">
                ...
                <div class="form-group @error('role_name') has-error @enderror">
                  ...
                  <input type="text" class="form-control" name="group_name" value="{{ old('role_name')}}" required>
                  @error('role_name')
