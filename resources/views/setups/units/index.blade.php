    ...
    <div class="col-lg-12 col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">{{ __('title.list_units') }}</h3>
              <!-- tools box - add new record-->
              @if(Auth::user()->allowCreate(config('global.modules.product')))
              <div class="pull-right box-tools">
                <a href="{{ route('unit.create') }}" class="btn btn-primary btn-sm" data-widget="add-new" data-toggle="tooltip"
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('unit.edit', $item->id) }}" title="Edit"><i class="fa fa-pencil"></i></a>
                      @endif                      
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title">{{ __('title.delete') }} - {{$item->unit_name}}</h4>
                            </div>
                            ...
                            <div class="modal-footer">
                              <form action="{{ route('unit.delete', $item->id) }}" method="POST">
                                @csrf
            ...
            <div class="box-footer clearfix">
              @include('layouts.pagination', ['data'=>$units])
            </div>             
          </div>      
    </div>
  </div>
