            ...
            <div class="box-body">    
             <div class="row">
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      ...
                      <select class="form-control" name="role">
                        ...
                        <option value="{{ $item->id }}" @if($item->id == old('role')) selected @endif >{{ $item->role_name }}</option>
                        @endforeach
                      </select>  
                      @error('role')
                        <span class="help-block">{{ $message }}</span>
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      ...
                      <select class="form-control" name="location_id">
                        ...
                        <option value="{{ $item->id }}" @if($item->id == old('location_id')) selected @endif >{{ $item->location_name }}</option>
                        @endforeach
                      </select>  
                      @error('location_id')
                        <span class="help-block">{{ $message }}</span>
              ...
              <div class="col-lg-6 col-md-4 col-sm-12">
                <div class="form-group">
                  <img id="blah" src="{{ url(config('global.paths.user')) }}/user-placeholder.jpg" width="150px" height="150px;" alt="your image" /> <br/><br/>
