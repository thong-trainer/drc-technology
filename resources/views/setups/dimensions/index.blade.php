    ...
    <div class="col-lg-12 col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">{{ __('title.list_dimensions') }}</h3>
              <!-- tools box - add new record-->
              @if(Auth::user()->allowCreate(config('global.modules.dimension')))
              <div class="pull-right box-tools">
                <a href="{{ route('dimension.create') }}" class="btn btn-primary btn-sm" data-widget="add-new" data-toggle="tooltip"
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="{{ route('dimension.edit', $item->id) }}" title="Edit"><i class="fa fa-pencil"></i></a>
                      @endif                      
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              <form action="{{ route('dimension.delete', $item->id) }}" method="POST">
                                @csrf
            ...
            <div class="box-footer clearfix">
              @include('layouts.pagination', ['data'=>$dimensions])
            </div>             
          </div>      
    </div>
  </div>
