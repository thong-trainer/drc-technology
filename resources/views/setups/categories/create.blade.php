             ...
             <div class="row">
              <div class="col-lg-6 col-md-8 col-sm-12">
                <div class="form-group @error('category_name') has-error @enderror">
                  ...
                  <input type="text" class="form-control" id="name" name="category_name" value="{{ old('category_name')}}" required>
                  @error('category_name')
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      ...
                      <select class="form-control select2" name="parent">
                        ...
                        <option value="{{ $item->id }}"  @if(old('parent') == $item->id) selected @endif>{{ $item->category_name }}</option>
                        @endforeach
                      </select>  
                      @error('parent')
                        <span class="help-block">{{ $message }}</span>
              ...
              <div class="col-lg-6 col-md-4 col-sm-12">
                <div class="form-group">
                  <img class="img-upload" id="blah" src="{{ url('uploads') }}/no-image-placeholder.jpg" alt="your image" />
